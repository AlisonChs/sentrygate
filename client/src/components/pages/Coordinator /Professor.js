...
export function Professor ({openCriarProf, setOpenCriarProf}) {
  ...
  const handleCloseCriarProf = () => setOpenCriarProf(false);
    ...
    return (
      ...
      >
        <Fade in={openCriarProf}>
          <Box sx={modalStyle}>
            <Typography id="transition-modal-title" variant="h4" component="h2">
              Inserir um professor
            </Typography>
            <Typography id="transition-modal-description" sx={{ mt: 2, mb: 3, color:  "white"}}>
              Insira os dados do professor que deseja inserir e deixe o resto conosco!
            </Typography>
 
            <StyledTextField sx={{color: 'white' }} helperText="Insira o nome do professor" id="standard-basic" label="Nome da turma" variant="standard" />
